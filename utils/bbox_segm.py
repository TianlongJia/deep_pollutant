...
excel_path = r"/scratch/tjian/PythonProject/DP_MMDetection/checkpoints/train_weights/Paper_Peng/test.xlsx"
worksheet = "Sheet1"

def save_bbox_info_in_excel(worksheet, filename_list, 
