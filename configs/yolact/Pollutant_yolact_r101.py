# Copy the setting from "yolact_r101_1xb8-55e_coco.py"
...
model = dict(
    ...
    backbone=dict(
        ...
        init_cfg=dict(type='Pretrained',
                      prefix='backbone',
                      checkpoint='/scratch/tjian/PythonProject/DP_MMDetection/checkpoints/pretrained_weights/yolact_r101_1x8_coco_20200908-4cbe9101.pth'
                      )),
    neck=dict(
        type='FPN',
